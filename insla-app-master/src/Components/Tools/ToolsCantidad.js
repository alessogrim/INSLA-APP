...
export default class ToolsCantidad extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      stockAdmin: this.props.navigation.state.params.tool.data().stock,
      stock: 0,
      taken: false,
      Loaded: true,
          ...
          >
            <Left>
              <Icon
                ...
                onPress={() => this.props.navigation.navigate("addTools")}
              />
            </Left>
            <Body>
              ...
              <Form style={style.container}>
                ...
                >
                  ...
                  >
                    ...
                    <Label>Existencia en Finca</Label>
                    <Input
                      style={{ fontSize: 18, alignSelf: "flex-start" }}
