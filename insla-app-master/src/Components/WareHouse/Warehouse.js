      ...
      return (
        <View style={styles.container}>
          ...
          >
            ...
            <Body>
              <Title style={{ color: "#fff", fontSize: 19 }}>ALMACEN</Title>
            </Body>
            <Right />
          </Header>
          <View style={{ height: "100%", display: "flex" }}>
            ...
            >
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  this.props.navigation.navigate("tools", farm);
                }}
              >
                <View
                  style={{
            ...
            >
              <TouchableOpacity
                ...
                onPress={() => {
                  this.props.navigation.navigate("materials", { farm });
                }}
              >
                <View
                  style={{
                ...
                >
                  <SvgUri
                    width="80"
                    height="80"
                    source={require("../../../assets/icons/package.svg")}
                  />
                </View>
                <Text
                  style={{
