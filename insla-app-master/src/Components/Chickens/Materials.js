...
export default class Materials extends Component {
  ...
  async createMaterials(newMaterial) {
    await fs.collection('chickenMaterial').add(newMaterial)
  ...
  async getMaterials() {
    ...
    const querySnapshot = await fs.collection("chickenMaterial")
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          text: "Aceptar",
          onPress: async () => {
            await fs.collection("chickenMaterial")
              .doc(material._id)
              .delete()
            this.setState({
          ...
          onPress={() => {
            this.props.navigation.navigate("materials", {
              ...
              onSelect: (material) => {
                ...
                this.props.navigation.navigate("AddChickenMaterial", {
                  material: material.data(),
                  onCreate: async (chickenMaterial) => {
                    const newchickenMaterial = {
                      ...chickenMaterial,
                      material: material.id,
                      production: production._id
                    };
                    await this.createMaterials(newchickenMaterial);
