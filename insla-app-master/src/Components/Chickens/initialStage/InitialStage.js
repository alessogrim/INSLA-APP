...
export default class InitialStage extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      workforce_initialStage_chicken_breeding: [],
      chicken_food_initialStage_chicken_breeding: []
    };
  }

  componentDidMount() {
    fs.collection("workforce_initialStage_chicken_breeding")
      ...
      .then(query => {
        query.forEach(doc => {
          this.setState({
            workforce_initialStage_chicken_breeding: [
              ...this.state.workforce_initialStage_chicken_breeding,
              doc
            ]
          });
        });
        ...
        fs.collection("chicken_food_initialStage_chicken_breeding")
          ...
          .then(query => {
            query.forEach(doc => {
              this.setState({
                chicken_food_initialStage_chicken_breeding: [
                  ...this.state.chicken_food_initialStage_chicken_breeding,
                  doc
                ]
              });
            });
        ...
        },
        {
          ...
          onPress: () => {
            fs.collection("workforce_initialStage_chicken_breeding")
              ...
              .then(() => {
                this.setState({
                  workforce_initialStage_chicken_breeding: this.state.workforce_initialStage_chicken_breeding.filter(
                    (e, i) => {
                      return i !== index;
                    }
                  )
        ...
        },
        {
          ...
          onPress: () => {
            fs.collection("chicken_food_initialStage_chicken_breeding")
              ...
              .then(() => {
                this.setState({
                  chicken_food_initialStage_chicken_breeding: this.state.chicken_food_initialStage_chicken_breeding.filter(
                    (e, i) => {
                      return i !== index;
                    }
                  )
  ...
  render() {
    ...
    if (!Loaded) {
      ...
      const workforce_initialStage = this.state.workforce_initialStage_chicken_breeding.map(
        (doc, index) => {
          return (
      ...
      const chickenFood_initialStage = this.state.chicken_food_initialStage_chicken_breeding.map(
        (doc, index) => {
          return (
            <ListItem avatar key={index}>
              <Left>
        ...
        <View style={styles.container}>
          ...
          <Tabs>
            ...
            >
              ...
              >
                <ScrollView>{workforce_initialStage}</ScrollView>
              </Container>
              <Fab
                ...
                onPress={() => {
                  this.props.navigation.navigate("employeesList", {
                    ...
                    screen: "addWorkerInitialStage", // pantalla adonde deberia de ir a parar cuan se seleccione un empleado
            ...
            >
              ...
              >
                <ScrollView>{chickenFood_initialStage}</ScrollView>
              </Container>
              <Fab
                direction="up"
                style={{
                ...
                onPress={() => {
                  this.props.navigation.navigate("concentrateList", {
                    farm: this.state.farm,
                    screen: "addFoodInitialState", // pantalla adonde deberia de ir a parar cuando se seleccione un empleado
                    production: this.state.production,
