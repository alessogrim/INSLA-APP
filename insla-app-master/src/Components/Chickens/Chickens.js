      ...
      return (
        <View style={styles.container}>
          ...
          >
            ...
            <Body>
              <Title style={{ color: "#fff", fontSize: 19 }}>AVES</Title>
            </Body>
            <Right />
          </Header>
          ...
          <View style={{ height: "100%", display: "flex" }}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={() => {
                  this.props.navigation.navigate("ChickenFarming", farm);
                }}
              >
                <View
                  style={{
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  this.props.navigation.navigate("EggsProduction", farm);
                }}
              >
                <View
                  style={{
                ...
                >
                  <SvgUri
                    width="80"
                    height="80"
                    source={require("../../../assets/icons/eggs.svg")}
                    paddin
                  />
                </View>
                <Text
