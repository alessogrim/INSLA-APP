...
export default class EggsRawMaterial extends Component {
  ...
  async componentDidMount() {
    ...
    //   .collection("eggsProductions")
    //   .doc(this.state.production._id)
    //   .get();
    //   console.log(production.data())
    this.setState({
      totalChickens: this.state.production.male || 0,
      deaths: this.state.production.deaths || 0,
      eggs: this.state.production.eggs || 0

    });

    fs.collection("corrales")
      .doc(this.state.production.corral)
      .get()
      .then(corral => {
    ...
    if (this.state.totalChickens != 0) {
      ...
      fs.collection("eggsProductions")
        ...
        .update({
          ...
          male: this.state.totalChickens,
          eggs: this.state.eggs
        })
        .then(() => {
            this.state.production.male = this.state.totalChickens
            this.state.production.deaths = this.state.deaths
            ...
            >
              ...
              >
                <Icon
                  ...
                  onPress={() => {
                    if (this.state.totalChickens < maxCapacity) {
                      this.setState({
                        totalChickens: this.state.totalChickens + 1
                      });
                    }
